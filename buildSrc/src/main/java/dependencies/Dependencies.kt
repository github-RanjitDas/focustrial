...
object Dependencies {
    ...
    object Base {
        ...
        const val externalHardware = "com.safefleet.mobile:external-hardware:5.12.6-SNAPSHOT@jar"
        const val kotlinCommons = "com.safefleet.mobile:kotlin-commons:1.3.0-SNAPSHOT@jar"
